...
import (
	...
	"github.com/apexinfosysindia/os-agent/boards/green"
	"github.com/apexinfosysindia/os-agent/boards/rpi"
	"github.com/apexinfosysindia/os-agent/boards/supervised"
	"github.com/apexinfosysindia/os-agent/boards/yellow"
	logging "github.com/apexinfosysindia/os-agent/utils/log"
)

const (
	objectPath = "/io/apexos/os/Boards"
	ifaceName  = "io.apexos.os.Boards"
)
